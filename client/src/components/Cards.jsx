        ...
        <div className="w-80 h-5/6 group transition duration-500 ease-in-out transform hover:scale-110 hover:flex-grow shadow-xl -ml-60">
            <div
                ...
                >
                    ...
                    <p className="card-name">{cat.cat.name}({cat.cat.race})</p>
                    <span className="card-gender">{cat.cat.gender},</span>
                    <span className="card-age">{cat.cat.age} years old</span>
                    <h3 className="card-location"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-500 float-left" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                    </svg>{cat.cat.User.location}</h3>
