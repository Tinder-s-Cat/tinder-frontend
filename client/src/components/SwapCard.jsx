	...
	<>
		...
		<div className="space-x-2 buttonSwipe">
			<div onClick={() => handleSkip()} className="buttonSwipe_skip">
				<svg xmlns="http://www.w3.org/2000/svg" class="transform hover:scale-110 h-16 w-16 svg text-gray-500 hover:text-gray-900" title="Skip" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
				</svg>
			</div>
			<div onClick={handleRefresh} className="buttonSwipe_ref">
				<svg xmlns="http://www.w3.org/2000/svg" class="transform hover:scale-110 h-2 w-2 svg text-yellow-600 hover:text-yellow-700" title="Refresh" viewBox="0 0 20 20" fill="currentColor">
					<path fill-rule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clip-rule="evenodd" />
				</svg>
			</div>
			<div onClick={handleLike} className="buttonSwipe_like">
				<svg xmlns="http://www.w3.org/2000/svg" class="transform hover:scale-110 h-2 svg w-2 text-blue-600 hover:text-blue-700 text-sm" title="Like" viewBox="0 0 20 20" fill="currentColor">
